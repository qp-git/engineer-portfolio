...
今後は、既存プロジェクトの改善と新規学習テーマの追加をIssueで管理しながら進めます。

STT + ECSの再開手順整理やCodePipelineによるCI/CD検証に加え、SQL / BigQueryを使った家計簿データ分析、Lubuntu端末とクラウドを組み合わせたハイブリッド運用環境の検証を予定しています。
