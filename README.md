...
- [Lubuntu端末とクラウドを組み合わせたハイブリッド運用環境](https://github.com/qp-git/engineer-portfolio/issues/2)
  - ローカルLinux端末とAWSを組み合わせた運用検証テーマです。
- [クレジットカード明細を使った家計簿DB・SQL分析基盤](https://github.com/qp-git/engineer-portfolio/issues/1)
  - SQL / BigQuery / セキュリティを意識したデータ分析基盤の検証テーマです。
