...
## 1. Before: GitHub Actions側が本番入口を受けている状態
...
## 2. Migration validation: HTTP:81でPipeline側を事前確認
...
## 3. Cutover: 本番HTTPS:443をPipeline側へ切り替える
...
## 4. Post-deploy Smoke Test: 本番URL経由でユーザー経路を確認する
