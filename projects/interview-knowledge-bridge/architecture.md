...
このホワイトリストにより、GitHub 上のすべてのファイルを AI に読ませるのではなく、ポートフォリオ整理や回答生成に使ってよい文書だけを明示的に指定します。
...
公開されている情報であっても、すべてを AI に読ませると、回答に関係ない情報や古いメモが混ざる可能性があります。
